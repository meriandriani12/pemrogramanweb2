  ...
  <table class="table table-striped mt-3">
    ...
    <tbody>
      ...
      <td><?=$buku['thumbnail_url']; ?></td>
        ...
        <td>
          <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal" data-bs-id="<?= $buku['id']; ?>"><i class="bi bi-pencil-square"></i> Edit</button>
      ...
      <div class="modal-body">
        <form action="/databuku.php/simpan" method="POST" id="formTambah">
          ...
          <div class="mb-3">
            ...
            <input type="file" accept="image/*" name="thumbnail_url" id="thumbnail_url" class="form-control" placeholder="https:/example.com/image.jpg">
          </div>
        </form>
      </div>
